...
-   The relationship between the predictors and the response is \alert{additive}.
    -   $\Rightarrow$ *The association between a predictor and the response does not depend on any of the other predictors.*
-   The relationship between the predictors and the response is \alert{linear}.
    -   $\Rightarrow$ *A one-unit change in a predictor induces a constant change in the response regardless of the value of the predictor.*
...
$$ We can include the product of $X_1$ and $X_2$ as a third predictor called the **interaction term**. $$Y=\beta_{0}+\beta_{1} X_{1}+\beta_{2} X_{2}+\alert{\beta_{3} X_{1} X_{2}}+\epsilon$$ This means that a change in the value of $X_2$ will change the association between $X_1$ and $Y$.
...
![](images/residuals-01.png){fig-align="center" width="214"}
...
![](images/uncorrelated_error.png){fig-align="center" width="448"}

![](images/correlated_error.png){fig-align="center" width="448"}
...
![](images/variance_errors.png){fig-align="center" width="212"}
...
![](images/studentized_re.png){fig-align="center" width="225"}
...
::: columns
::: {.column width="50%"}
![](images/simple_leverage.png){fig-align="center" width="127"}
:::

::: {.column width="50%"}
![](images/multiple_leverage.png){fig-align="center" width="127"}
:::
:::
