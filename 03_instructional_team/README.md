...
The `/01_materials/notebooks` directory contains exercises related to each live learning session. The technical facilitator will review each exercise at the end of the live learning sessions. 
...
Focus of the week is on intro and classification.

### Week 2

Focus of the week is on clustering and regression part one.

### Week 3

Focus of the week is on regression part two and statistical inference.
