...
| 4      | Monday 27 February     |  Resampling methods (CV, bootstrap), Linear model selection and regularization            | [Slides](https://github.com/UofT-DSI/06-statistical_learning/blob/main/lessons/6.5-Linear_Model_Selection_and_Regularisation_slides.pdf) | 5, 6               
